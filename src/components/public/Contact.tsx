...
export default function Contact() {
  return (
    <section id="contact" className="py-20 md:py-28 bg-navy/[0.03]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Heading */}
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-4">Get In Touch</h2>
          <div className="w-[60px] h-[3px] bg-blue mx-auto mb-6" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          <Card hover>
            <div className="flex flex-col items-center text-center py-4">
              ...
              <p className="text-sm font-medium text-gray mb-1">Email Me</p>
              <a
                href={`mailto:${siteConfig.email}`}
                className="text-navy font-semibold transition-colors duration-200 hover:text-blue"
              >
                {siteConfig.email}
              </a>
            </div>
          ...
          <Card hover>
            <div className="flex flex-col items-center text-center py-4">
              ...
              <p className="text-sm font-medium text-gray mb-1">Call Me</p>
              <a
